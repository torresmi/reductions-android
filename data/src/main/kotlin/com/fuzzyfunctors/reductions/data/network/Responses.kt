...
fun <A> Response<A>.toEither(): Either<LoadingFailure.Remote, A> = if (isSuccessful) {
    Either.Right(body()!!)
} else {
...
fun <A : Any> Response<A>.toRemoteData(): RemoteData<LoadingFailure.Remote, A> = if (isSuccessful) {
