...
class RemoteDataViewFlipper
    ...
    constructor(
        ...
        init {
            ...
            try {
                val notAskedId = a.getResourceId(
                    R.styleable.RemoteDataView_notAskedView,
                    defaultResId,
                )
                ...
                val successId = a.getResourceId(
                    R.styleable.RemoteDataView_successView,
                    defaultResId,
                )
                val failureId = a.getResourceId(
                    R.styleable.RemoteDataView_failureView,
                    defaultResId,
                )
        ...
        private fun addSpecifiedSuccessView(
